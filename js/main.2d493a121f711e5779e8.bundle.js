(self["webpackChunkgreens"] = self["webpackChunkgreens"] || []).push([[179],{
...
var fslightbox = __webpack_require__(869);
...
core.use([Navigation, Pagination, Scrollbar, EffectCoverflow]);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Sidebar Trigger
  var sidebarTrigger = document.querySelectorAll(".js-sidebar-trigger"),
    sidebarCloseBtn = document.querySelector("[data-close]");

  // console.log(sidebar);

  sidebarTrigger === null || sidebarTrigger === void 0 ? void 0 : sidebarTrigger.forEach(function (btn) {
    var name = btn.dataset.sidebar;
    var sidebar = document.querySelector(".js-sidebar-" + name);
    btn.addEventListener("click", function (e) {
      e.preventDefault();
      opensidebar(sidebar);
    });
  });
  sidebarCloseBtn === null || sidebarCloseBtn === void 0 ? void 0 : sidebarCloseBtn.forEach(function (btn) {
    var name = btn.dataset.sidebar;
    var sidebar = document.querySelector(".js-sidebar-" + name);
    btn.addEventListener("click", function (e) {
      e.preventDefault();
  ...
  document.addEventListener("click", function (e) {
    sidebarTrigger === null || sidebarTrigger === void 0 ? void 0 : sidebarTrigger.forEach(function (btn) {
      ...
      var sidebarName = document.querySelector(".js-sidebar-" + name);
  ...
  var btnToTop = document.getElementById("js-to-top");
  btnToTop.addEventListener("click", scrollToTop);

  // Swiper fith filter
  filterSelection('all');
  var filterSwiper = new core('.swiper-filter', {
    slidesPerView: 4
  });
  var productSwiper = new core('.swiper-product', {
    slidesPerView: 1,
    loop: true,
    centeredSlides: false,
    freeMode: true,
  ...
  function filterSelection(filterName) {
    ...
    for (i = 0; i < li.length; i++) {
      ...
      if (li[i].className.indexOf(filterName) > -1) addClass(li[i], ' block');
    }
  }
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      current[0].className = current[0].className.replace(' swiper-btn-active', '');
  ...
  // Swiper Reviews
  var reviewsSwiper = new core('.swiper-reviews', {
    slidesPerView: 1,
    effect: "fade",
    pagination: {
      el: ".swiper-pagination",
  ...
  var partnersSwiper = new core('.swiper-partners', {
    slidesPerView: "auto",
    pagination: {
      el: ".swiper-pagination",
      clickable: true,
  ...
  // DD Catalog
  var jsDdCatalog = document.getElementById("js-dd-catalog");
  ...
  var jsDdBtn = document.querySelector(".js-dd-btn");
  ...
  var jsBtnsIncrease = document.querySelectorAll(".js-increase");
  var jsBtnsDecrease = document.querySelectorAll(".js-decrease");
  jsBtnsIncrease.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      increaseCount(e, this);
    });
  });
  jsBtnsDecrease.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
  ...
  var jsBtnsOrderDelete = document.querySelectorAll(".js-product-delete");
  jsBtnsOrderDelete.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      deleteOrder(this);
    });
  });
  ...
  // Btn active
  var jsBtns = document.querySelectorAll(".js-btn");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  gsapWithCSS.utils.toArray(".gs_reveal").forEach(function (elem) {
    hide(elem);
  ...
  // gsap Header anim
  var showAnim = gsapWithCSS.from('.js-header', {
    yPercent: -100,
    paused: true,
    duration: 0.2
  }).progress(1);
